...
/**
 * Small, safe facade for Chat instrumentation. It deliberately exposes only metadata
 * and never accepts message text, URLs, tokens, credentials or private media content.
 */
object ChatDiagnostics {
